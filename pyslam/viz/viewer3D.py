...
from pyslam.slam import Map, MapState
...
class Viewer3DMapInput:
    def __init__(self):
        ...
        # self.spanning_tree = []
        # self.loops = []
        self.map_data: "MapState" | None = None
        #
...
class Viewer3D(object):
    ...
    def draw_slam_map(self, slam: "Slam"):
        ...
        #     if num_map_points > kMaxSparseMapPointsToVisualize:
        #         Printer.orange(
        #             f"Viewer3D: draw_slam_map - downsampling map points from {num_map_points} to {kMaxSparseMapPointsToVisualize}"
        #         )
        #         idx = np.random.choice(
        #             num_map_points, kMaxSparseMapPointsToVisualize, replace=False
        #         )
        ...
        map_state.map_data = slam.map.get_data_arrays_for_drawing(
