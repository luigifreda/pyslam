...
class Tracking:
    ...
    def find_homography_with_ransac(self, f_cur, f_ref, idxs_cur, idxs_ref, reproj_threshold=4, min_num_inliers=15):
    ...
    def track_previous_frame(self, f_ref: Frame, f_cur: Frame):            
        ...
        if use_search_frame_by_projection: 
            ...
            if f_cur.is_blurry or f_ref.is_blurry:
                ...
                if matching_is_ok:
                    Printer.orange(f"# matched map points with homography and RANSAC: {self.num_matched_kps}, percentage of inliers: {self.num_matched_kps/(num_outliers+self.num_matched_kps)*100:.2f}%")                              
