...
inline std::pair<double, py::dict> global_bundle_adjustment_wrapper(
    const std::vector<KeyFramePtr> &keyframes, const std::vector<MapPointPtr> &points,
...
inline std::tuple<double, bool, int> pose_optimization_wrapper(FramePtr frame, bool verbose = false,
                                                               int rounds = 10) {
...
optimize_sim3_wrapper(KeyFramePtr kf1, KeyFramePtr kf2, const std::vector<MapPointPtr> &map_points1,
...
inline double optimize_essential_graph_wrapper(
