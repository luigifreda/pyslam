...
CameraPose::CameraPose()
    : pose_(std::make_unique<Eigen::Isometry3d>()), Tcw_(Eigen::Matrix4d::Identity()),
...
CameraPose::CameraPose(const Eigen::Isometry3d &pose)
    : pose_(std::make_unique<Eigen::Isometry3d>(pose)), Tcw_(Eigen::Matrix4d::Identity()),
      Rcw_(Eigen::Matrix3d::Identity()), tcw_(Eigen::Vector3d::Zero()),
      Rwc_(Eigen::Matrix3d::Identity()), Ow_(Eigen::Vector3d::Zero()) {
    initialize_covariance();
    update_cached_matrices();
...
CameraPose::CameraPose(const CameraPose &other)
    : pose_(std::make_unique<Eigen::Isometry3d>(*other.pose_)), Tcw_(other.Tcw_), Rcw_(other.Rcw_),
      tcw_(other.tcw_), Rwc_(other.Rwc_), Ow_(other.Ow_), covariance_(other.covariance_) {}
