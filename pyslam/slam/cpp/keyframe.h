...
class KeyFrameGraph {
  ...
  public:
    ...
    // KeyFrameGraph(const KeyFrameGraph &other) = default;
    // KeyFrameGraph &operator=(const KeyFrameGraph &other) = default;
    // KeyFrameGraph(KeyFrameGraph &&other) noexcept = default;
    // KeyFrameGraph &operator=(KeyFrameGraph &&other) noexcept = default;
...
class KeyFrame : public Frame, public KeyFrameGraph, public std::enable_shared_from_this<KeyFrame> {
  ...
  public:
    ...
    // Serialization
    std::string to_json() const;
    static std::unique_ptr<KeyFrame> from_json(const std::string &json_str);
    void replace_ids_with_objects(const std::vector<MapPoint *> &points,
                                  const std::vector<Frame *> &frames,
                                  const std::vector<KeyFrame *> &keyframes);
