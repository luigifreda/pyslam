...
class CameraPose {
  private:
    ...
    Eigen::Matrix4d Tcw_; // homogeneous transformation matrix
    Eigen::Matrix3d Rcw_; // rotation matrix
    Eigen::Vector3d tcw_; // translation vector
    Eigen::Matrix3d Rwc_; // inverse rotation matrix
    Eigen::Vector3d Ow_;  // camera origin in world coordinates
