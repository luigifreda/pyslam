...
- [Scene From Views](#scene-from-views)
    ...
    - [3. Scene Optimization Modules](#3-scene-optimization-modules)
        ...
        - [3.3. Configuration Dictionary](#33-configuration-dictionary)
            - [3.3.1. DenseSceneOptimizer Parameters](#331-densesceneoptimizer-parameters)
            - [3.3.2. SparseSceneOptimizer Parameters](#332-sparsesceneoptimizer-parameters)
        - [3.4. Global Scene Optimization Details](#34-global-scene-optimization-details)
            - [3.4.1. Dense Scene Optimization global_aligner](#341-dense-scene-optimization-global_aligner)
            - [3.4.2. Sparse Scene Optimization sparse_scene_optimizer](#342-sparse-scene-optimization-sparse_scene_optimizer)
