...
Different semantic mapping methods can be supported. Currently, we support semantic mapping using dense
semantic segmenetation. Semantic features are assigned to keypoints on
the image and fused into map points. The semantic features can be: 
\begin{itemize}
\item Labels: categorical labels as numbers.
\item Probability vectors: probability vectors for each class.
\item Feature vectors: feature vectors
