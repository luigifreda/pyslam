...
\href{./pyslam/config_parameters.py}{config\_parameters.py}. Further
...
\href{./pyslam/config_parameters.py}{config\_parameters.py}.
...
parameters set in \href{./pyslam/config_parameters.py}{config\_parameters.py}.
...
parameters in \href{./pyslam/config_parameters.py}{config\_parameters.py}.
