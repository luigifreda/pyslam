graph LR;
    ...
    scene_from_views_factory -->|*SceneFromViewsType.FAST3R*| SceneFromViewsFast3r
    ...
    SceneFromViewsFast3r -->|*_is-a_*| SceneFromViewsBase;
    ...
    class SceneFromViewsFast3r implementation;
