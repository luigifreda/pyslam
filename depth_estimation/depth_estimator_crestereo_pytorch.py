...
class DepthEstimatorCrestereoPytorch(DepthEstimator):
    ...
    def __init__(self, device=None, camera:Camera=None,
        ...
        super().__init__(model=model, transform=None, device=device, camera=camera, 
    ...
    def load_model(self, model_path=kCrestereoModelPath):
        ...
        model = crestereo_pytorch_nets.Model(max_disp=self.max_disparity, mixed_precision=False, test_mode=True)
