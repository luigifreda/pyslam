...
def labels_color_map_factory(semantic_dataset_type=SemanticDatasetType.CITYSCAPES):
...
def information_weights_factory(semantic_dataset_type=SemanticDatasetType.CITYSCAPES):
    if semantic_dataset_type == SemanticDatasetType.VOC:
