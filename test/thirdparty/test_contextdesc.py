...
tf.app.flags.DEFINE_string(
    "loc_model",
    contextdesc_base_path + "pretrained/contextdesc++",
    """Path to the local feature and augmentation model.""",
)
tf.app.flags.DEFINE_string(
    "reg_model",
    contextdesc_base_path + "pretrained/retrieval_model",
    """Path to the regional feature model.""",
)
tf.app.flags.DEFINE_string(
    "img1_path", contextdesc_base_path + "imgs/test_img1.jpg", """Path to the first image."""
)
tf.app.flags.DEFINE_string(
    "img2_path", contextdesc_base_path + "imgs/test_img2.jpg", """Path to the second image."""
)
tf.app.flags.DEFINE_integer("n_sample", 2048, """Maximum number of keypoints. Sampled by octave.""")
# model options
tf.app.flags.DEFINE_string("model_type", "pb", """Pre-trained model type.""")
tf.app.flags.DEFINE_boolean("dense_desc", False, """Whether to use dense descriptor model.""")
# matching options
tf.app.flags.DEFINE_boolean("ratio_test", False, """Whether to apply ratio test in matching.""")
tf.app.flags.DEFINE_boolean("cross_check", False, """Whether to apply cross check in matching.""")
