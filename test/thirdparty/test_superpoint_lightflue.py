...
while dataset.isOk():
    ...
    with torch.inference_mode():
        ...
        kps, des = (
            current_features["keypoints"].squeeze().cpu().numpy(),
            current_features["descriptors"].squeeze().cpu().numpy(),
        )
        cur_remake = {
        ...
        print(
            cur_remake["keypoints"].shape,
            cur_remake["image_size"].shape,
            cur_remake["descriptors"].shape,
        )
