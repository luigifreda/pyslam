...
parser.add_argument(
    "--image_file",
    type=str,
    default="../data/kitti06-12-color.png",  # required=True,
    help="img file to process",
)

parser.add_argument(
    "--preprocessing", type=str, default="caffe", help="image preprocessing (caffe or torch)"
)
parser.add_argument(
    "--model_file",
    type=str,
    default=d2net_base_path + "models/d2_tf.pth",
...
parser.add_argument(
    "--max_sum_edges", type=int, default=2800, help="maximum sum of image sizes at network input"
)
...
parser.add_argument(
    "--multiscale", dest="multiscale", action="store_true", help="extract multiscale features"
)
