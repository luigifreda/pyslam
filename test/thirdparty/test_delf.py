...
def MakeExtractor(sess, config, import_scope=None):
    ...
    """
    tf.saved_model.load(
        sess, [tf.saved_model.tag_constants.SERVING], config.model_path, import_scope=import_scope
    )
...
def main(unused_argv):
    ...
    delf_config.delf_local_config.pca_parameters.projection_matrix_path = (
        delf_projection_matrix_path
    )
