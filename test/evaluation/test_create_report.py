...
# Just create a report from an output folder
if __name__ == "__main__":
    ...
    # evaluation_manager.run_evaluation() # here we do not run the evaluation since we just want to create the report from the results folder
