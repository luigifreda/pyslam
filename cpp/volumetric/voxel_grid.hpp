...
void VoxelGridT<VoxelDataT>::carve(const CameraFrustrum &camera_frustrum, cv::Mat &depth_image,
    ...
    if (depth_image.rows == 0 || depth_image.cols == 0 ||
        ...
        std::cout << "VoxelGridT<VoxelDataT>::carve: Depth image size: " << depth_image.rows << "x"
                  << depth_image.cols << std::endl;
    ...
    if (depth_image.type() != CV_32F) {
        ...
        std::cout << "VoxelGridT<VoxelDataT>::carve: Depth image type: " << depth_image.type()
                  << std::endl;
